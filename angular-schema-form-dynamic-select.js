...
angular.module('schemaForm').controller('dynamicSelectController', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.find_in_titleMap = function (value) {
        console.log(".................................." + value.toString() + "-----" + $scope.form.key.toString())
